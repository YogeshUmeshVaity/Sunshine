...
public class TestProvider extends AndroidTestCase {
    ...
    public void testInsertReadProvider() {
        ...
        // Another way to test notifyChange() is using Roboelectric : http://stackoverflow.com/questions/11482104/how-to-junit-test-contentresolver-notifychange/14407959#14407959

        // Did our content observer get called?  Students:  If this fails, your insert location
        // isn't calling getContext().getContentResolver().notifyChange(uri, null);
        // waitForNotificationOrFail() will throw RunTimeException if notifyChange() is not called.
        tco.waitForNotificationOrFail();
        ...
        // TODO: 4/4/16 close locationCursor and weatherCursor here. 
        // A cursor is your primary interface to the query results.
        Cursor locationCursor = mContext.getContentResolver().query(
                LocationEntry.CONTENT_URI,
        ...
        tco.waitForNotificationOrFail();
        // if the user moved out of your activity or closes the app then you don't need to update
        // your UI (so you don't need to get event for changes), so you would unregister the
        // content observer.
        mContext.getContentResolver().unregisterContentObserver(tco);
    ...
    public void testProviderRegistry() {
        ...
        try {
            ...
            assertEquals(
                    "Error: WeatherProvider registered with authority: " +
