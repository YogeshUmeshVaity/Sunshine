...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String getReadableDateString(long time) {
        ...
        SimpleDateFormat simpleFormat = new SimpleDateFormat("E, MMM d");
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                ...
                mContext.getString(R.string.pref_temperature_units_metric_value));

        if (unitType.equals(mContext.getString(R.string.pref_temperature_units_imperial_value))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_temperature_units_metric_value))) {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            Uri uri = contentResolver.insert(WeatherContract.LocationEntry.CONTENT_URI,
                    locationValues);
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            // Insert location info into database.
            ...
            dayTime.setToNow();
            Log.d(LOG_TAG, "getWeatherDataFromJson current setToNow(): " + dayTime.toString());
            ...
            if (cVVector.size() > 0) {
                ...
                ContentValues[] fourteenDaysWeather = new ContentValues[cVVector.size()];
                cVVector.toArray(fourteenDaysWeather);
                contentResolver.bulkInsert(WeatherEntry.CONTENT_URI, fourteenDaysWeather);
            }
