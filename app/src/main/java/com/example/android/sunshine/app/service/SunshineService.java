...
public class SunshineService extends IntentService {
    private static final String LOG_TAG = "SunshineService.java";
    ...
    protected void onHandleIntent(final Intent intent) {
        ...
        // If there is no location specified, we end the service.
        ...
        try {
            ...
            // Get JSON data and add it to database.
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                inserted = contentResolver.bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, fourteenDaysWeather);
            }
